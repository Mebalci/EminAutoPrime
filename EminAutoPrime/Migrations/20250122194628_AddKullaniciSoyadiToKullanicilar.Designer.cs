...
namespace EminAutoPrime.Migrations
{
    ...
    [Migration("20250122194628_AddKullaniciSoyadiToKullanicilar")]
    partial class AddKullaniciSoyadiToKullanicilar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EminAutoPrime.Data.AplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EminAutoPrime.Models.KullaniciYorumlari", b =>
                {
            ...
            modelBuilder.Entity("EminAutoPrime.Models.Araclar", b =>
                {
                    ...
                    b.HasOne("EminAutoPrime.Data.AplicationUser", "Sahip")
                        .WithMany()
            ...
            modelBuilder.Entity("EminAutoPrime.Models.KullaniciYorumlari", b =>
                {
                    b.HasOne("EminAutoPrime.Data.AplicationUser", "Kullanici")
                        .WithMany()
            ...
            modelBuilder.Entity("EminAutoPrime.Models.Randevular", b =>
                {
                    ...
                    b.HasOne("EminAutoPrime.Data.AplicationUser", "Musteri")
                        .WithMany()
            ...
            modelBuilder.Entity("EminAutoPrime.Models.ServisIslemleri", b =>
                {
                    ...
                    b.HasOne("EminAutoPrime.Data.AplicationUser", "Calisan")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EminAutoPrime.Data.AplicationUser", null)
                        .WithMany()
